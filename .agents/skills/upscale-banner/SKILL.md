...
6. Refresh once and verify the current installed-content fingerprint remains terminal `installed`, retains the exact preview hash and decision history, and cannot re-enter selection.
7. Report validation and update checked-in memory.
