...
- `scripts/Update-BannerQueue.ps1`: maintains the fingerprinted queue.
...
3. Run `Update-BannerQueue.ps1 -Refresh -SelectNext`; confirm deterministic, nonduplicate selection.
