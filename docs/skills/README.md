...
| `upscale-background` | Validate explicit backgrounds across companion simfiles, compare dimensions/aspect ratios, stage faithful previews, require label-explicit install choices, and proof-complete hash-bound installs | [Upscale Background](upscale-background.md) |
