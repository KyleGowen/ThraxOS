...
- **2026-07-31:** Thraximundar is named for the Magic: The Gathering zombie; “Thrashimundar” is welcome when leaning into music, especially Metal.
- **2026-07-31:** ITGMania is a shared friends-and-family activity and a form of enjoyable aerobic exercise.
- **2026-07-31:** The owner wants remotely accessible agentic filesystem control, deep ITGMania competence, pack discovery/install support, GrooveStats support, play-stat reporting, backup monitoring, and durable checked-in knowledge.
...
- **2026-08-14:** Eliza likes Meghan Trainor, specifically `Me Too`; the owner requested that the existing chart be included in `Eliza's Favorites`.
...
- **2026-08-10:** Every banner generated from scratch must visibly include the canonical song name, full artist name, every featuring credit, and every remix/edit/mix/version label present in simfile metadata. Keep all required copy readable at song-wheel size; do not infer it from artwork or filenames.
- **2026-08-11:** When the owner dislikes an original banner and requests a new one from scratch, research authentic album or single artwork through Google Images and verify it on Discogs or another established music source; use the verified release art as inspiration for an original banner rather than preserving the rejected design.
- **2026-08-13:** When the owner requests a new song background from scratch, use verified album or single artwork as inspiration for an original full-screen opaque 1920 x 1080 composition, preserving exact simfile identity and the existing preview-before-install approval boundary.
